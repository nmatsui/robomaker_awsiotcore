...
This application is modified by Nobuyuki Matsui<nobuyuki.matsui@gmail.com>.
The original source code is here : [aws-robomaker-sample-application-helloworld](https://github.com/aws-robotics/aws-robomaker-sample-application-helloworld).
